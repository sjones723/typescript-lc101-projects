...
let logDaysToMars = `
${spacecraftName} would take ${daysToMars} days to get to Mars.
`;
...
logDaysToMars = `
 ${spacecraftName} would take ${getDaysToLocation(kilometersToMars)} days to get to Mars.
`;
console.log(logDaysToMars);
let logDaysToMoon = `
 ${spacecraftName} would take ${getDaysToLocation(kilometersToTheMoon)} days to get to Mars.
`;
